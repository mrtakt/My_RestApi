...
sendemail = 'dmprojectsekai@gmail.com'; //Email SMTP
fromsendemail = 'YK Project'; // From Email SMTP *kalau takde custom email kena sama email dengan Email SMTP
sendpwmail = 'gnryjvataxjdlopn'; // Password Email SMTP gnryjvataxjdlopn
domain = "api.ykproject.dev"; // domain website tanpa http or https
...
recaptcha_key_1 = '6LcYv2olAAAAAEkdcpli8CZinkHBk-8L_QnbtuK5';
recaptcha_key_2 = '6LcYv2olAAAAAKLt5MruVKOFIpMVM3LIo6Yv9b6V';
...
loghandler = {
  error: {
    status: false,
    code: 503,
    message: "[!] Tidak Ada Layanan Atau Error",
